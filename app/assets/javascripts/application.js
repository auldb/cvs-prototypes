...
function Accordion ($module) {
  ...
  this.$sections = $module.querySelectorAll('.ben-accordion__section')
  this.$showAllButton = ''
  this.browserSupportsSessionStorage = helper.checkForSessionStorage()

  this.controlsClass = 'ben-accordion__controls'
  this.showAllClass = 'ben-accordion__show-all'
  this.showAllTextClass = 'ben-accordion__show-all-text'

  this.sectionExpandedClass = 'ben-accordion__section--expanded'
  this.sectionButtonClass = 'ben-accordion__section-button'
  this.sectionHeaderClass = 'ben-accordion__section-header'
  this.sectionHeadingClass = 'ben-accordion__section-heading'
  this.sectionHeadingTextClass = 'ben-accordion__section-heading-text'
  this.sectionHeadingTextFocusClass = 'ben-accordion__section-heading-text-focus'

  this.sectionShowHideToggleClass = 'ben-accordion__section-toggle'
  this.sectionShowHideToggleFocusClass = 'ben-accordion__section-toggle-focus'
  this.sectionShowHideTextClass = 'ben-accordion__section-toggle-text'
  this.upChevronIconClass = 'ben-accordion-nav__chevron'
  this.downChevronIconClass = 'ben-accordion-nav__chevron--down'

  this.sectionSummaryClass = 'ben-accordion__section-summary'
  this.sectionSummaryFocusClass = 'ben-accordion__section-summary-focus'
}
...
Accordion.prototype.constructHeaderMarkup = function ($headerWrapper, index) {
  ...
  // Create a button element that will replace the '.ben-accordion__section-button' span
...
Accordion.prototype.getButtonPunctuationEl = function () {
  ...
  $punctuationEl.classList.add('govuk-visually-hidden', 'ben-accordion__section-heading-divider')
